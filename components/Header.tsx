      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center">
            <button className="bg-primary-600 hover:bg-primary-500 text-white px-6 py-2.5 rounded-full font-medium transition-all shadow-lg shadow-primary-500/20 text-sm">
              Contact Sales
            </button>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-slate-950 border-b border-white/10">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="pt-4">
              <button className="w-full bg-primary-600 text-white px-6 py-3 rounded-xl font-medium">
                Contact Sales
              </button>
            </div>
          </div>
